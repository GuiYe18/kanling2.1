...
function jumpH5() {
    ...
    if (isPCrouter) {
        ...
        if (notFlag) {
            ...
            // Fun.browserRedirect(`${Fun.getSiteRoot()}/plugins/shop_server${notFlag}?i=${Fun.getKeyByI()}}`);
        }
    }
...
export default {
    ...
    get(url, params, message) {
        console.log('getsssssssssssssssssssssssssssssssssssssssssssssss', url, params, message);
        let i = Fun.getKeyByI();
    ...
    post(url, formData, message, flag) {
        console.log('postsssssssssssssssssssssssssssssssssssssssssssssss', url, formData, message, flag);
