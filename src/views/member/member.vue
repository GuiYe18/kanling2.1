<template>
  <div>
    <div id="member-all 上" v-show="template" :class="[this.fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
      ...
      <van-popup class="poster-popup-class" v-model="posterShow" round>
        <yz-goodsposter :posterData="poster_Data" :defaultImg="poster" :width="`18.875rem`" v-on:finish="uploadImageM"></yz-goodsposter>
      </van-popup>
      <!-- 旧海报(坐等废弃,插件名:超级海报) -->
