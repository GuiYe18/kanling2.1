...
export default {
    ...
    */
    ...
    methods: {
        ...
        getNewDecorate(data) {
            console.log('initAdvertising', data);
        ...
        getMemberInfo(data, order, plugins) {
            ...
            that.love_integral = data.love_integral
            ...
            // 钱包存放本地
            var univalent = {}
            univalent.credit1 = data.credit1
            univalent.credit2 = data.credit2
            univalent.love_integral = data.love_integral
            window.localStorage.setItem('OrderPrice', JSON.stringify(univalent))
            // 邀请码
