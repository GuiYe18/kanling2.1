  ...
  <div id="goodsinfo" :class="[this.fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
      ...
      <div v-for="(item, index) in order_data" :key="index">
        ...
        <div class="tbs">
          ...
          <div class="num list">
            ...
            <div class="right">
              <font color="#E84E40">{{ (Number(item.order_goods_price)).toFixed(0) }}</font>
            </div>
          </div>
    ...
    <div class="tbs" style="margin-top: 0.625rem;">
      ...
      <div class="price list s" v-for="item in total_items" :key="item.code">
        ...
        <div class="left " v-show="typeOfMerchandise==5||typeOfMerchandise==7">{{ item.name=='订单总金额'?'订单总金额':'总运费' }} </div>
        <div class="right">
    ...
    <div class="detail_pay">
      <ul class="total">
        ...
        <li>
          合计：<font style="color: #f15353;"
            ><span class="span_t">{{ (Number(price)).toFixed(0) }}</span></font
          >
        </li>
      </ul>
