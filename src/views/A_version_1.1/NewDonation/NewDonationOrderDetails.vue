 ...
 * @LastEditTime: 2021-10-11 18:44:14
 * @FilePath: \you-shop1\src\views\A_version_1.1\NewDonation\NewDonationOrderDetails.vue
 * @Describe: 
-->
<template>
  <div class="content">
    ...
    <div class="bj">
      ...
      <div class="ShippingAddress">
        <div class="ShippingAddressLeft">
          ...
          <span class="TOP">{{ deliveryAnformation.mobile }}</span
          ><br />
