          ...
          <div v-if="parseFloat(item.redmoney) > 0" :class="{ receive: item.receive_status !== 0 }">
            ...
            <div class="iconInfo">
              <div>
                ...
                <img src="../../assets/newImg/index/在看.png" alt="" />
              ...
              <div>
                ...
                <img v-if="item.fabulousstatus === 0" src="../../assets/newImg/index/点赞.png" alt="" />
                <img v-else src="../../assets/newImg/index/点赞1.png" alt="" />
                <span>{{ item.fabulous }}</span>
              </div>
              <div>
                <!-- <van-icon size="1.25rem" name="chat" color="#dbdbdb" /> -->
                <img src="../../assets/newImg/index/评论.png" alt="" />
              ...
              <div>
                ...
                <img v-if="item.followstatus === 0" src="../../assets/newImg/index/收藏.png" alt="" />
                <img v-else src="../../assets/newImg/index/收藏1.png" alt="" />
...
export default {
  ...
  watch: {
    ...
    //     console.log("`````````````````````````````", this.$store.state.Homogeneous);
    //     setTimeout(() => {
  ...
  methods: {
    ...
    toDetail(obj) {
      ...
      if (obj.qsntype === 1) {
        this.$router.push(this.fun.getUrl("detailEnterprise", "", { enterpriseId: obj.id, receive_status: obj.receive_status }));
