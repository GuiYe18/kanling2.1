<template>
  <div>
    ...
    <div id="map" style="width: 100%; height: 100%">
      ...
      <div v-show="fromHome !== 1" id="panel" style="width: 100%; height: 53%"></div>
    </div>
  ...
  activated() {
    ...
    if (this.fromHome !== 1) {
      ...
      if (myLocation.point) {
        ...
        /**
         * @Author: 飞
         * @Date: 2021-06-15 14:08:10
         * @Describe:  location不存在 调用定位
         */
        this.getLocation();
      }
    }
  ...
  methods: {
          ...
          AMap.plugin("AMap.Geocoder", function () {
            ...
            geocoder.getAddress(e.data.location, function (status, result) {
              ...
              if (status === "complete" && result.info === "OK") {
                ...
                } else if (self.$route.query.tag == "selfCarry" || self.$route.query.tag == "goodsDetail") {
                  self.$router.replace(
                    self.fun.getUrl(
                      "SelfCarry_info",
                      {
    ...
    ready: function () {
      ...
      function select(e) {
        ...
        /**
         * @Author: 飞
         * @Date: 2021-06-15 14:48:12
         * @Describe: 全局搜索
         */
        // addcode存在vuex里起来
        that.$store.commit("adcode", e.poi.adcode);
        console.log('全局搜索addcode存在vuex里起来', e.poi.adcode);
        ...
        AMap.plugin("AMap.Geocoder", function () {
          ...
          geocoder.getAddress(e.poi.location, function (status, result) {
            ...
            if (status === "complete" && result.info === "OK") {
              ...
              } else if (th.$route.query.tag == "selfCarry" || th.$route.query.tag == "goodsDetail") {
                th.$router.replace(
