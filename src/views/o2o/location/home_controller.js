...
export default {
    ...
    created() {
        ...
        /**
         * @Author: 飞
         * @Date: 2021-06-11 18:33:11
         * @Describe: 
         */
        // 首次獲取本地代理
        this.getRegionInfo({ addcode: this.$store.state.o2oLocation.adcode })
        this.$store.commit("adcode", this.$store.state.o2oLocation.adcode);
    ...
    methods: {
        ...
        toDetail(obj) {
            this.$router.push(
                this.fun.getUrl('detailPeople', '', { peopleId: obj.mid, receive_status: obj.receive_status })
            )
        },

        ready() {
            let myLocation = this.$store.state.o2oLocation;
            console.log('次第二次第二次第二次第二次第二次第二次第二次第二次第二', myLocation);
            if (myLocation.point) {
                /**
                 * @Author: 飞
                 * @Date: 2021-06-11 18:33:11
                ...
                const formData = {
                    addcode: this.$store.state.adcode
                }
                // 第二次獲取代理
                this.getRegionInfo(formData)
                console.log('第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次第二次',);
        ...
        getLocation() {
            ...
            function onComplete(obj) {
                ...
                console.log('一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次一次');
