<template>
  <div class="U000005-template1" :class="className">
    <!-- style -->
    <div v-html="css"></div>
    ...
    <el-dialog title="请先关注微信公众号" :visible.sync="showOfficialAccounts" width="80%" center class="OfficialAccounts">
...
// 自定义样式
const css = function () {
  const { preview_color, border_style, search_border_radius, bg_color, border_color, font_color, city_font_color } = this.datas;
