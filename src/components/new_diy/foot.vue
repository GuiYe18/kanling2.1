...
export default {
  ...
  watch: {
    ...
    // listData(val) {
    //   // 写上你需要的东西;
    //   this.news = this.$store.state.NumberOfMessages; //消息数
    //   console.log("新的消息", val);
    // },
  ...
  mounted() {
    ...
    //获取到的会话列表 存到vuex
    // window.GetAListOfSessions_vue = this.GetAListOfSessions_vue;
    // 最新消息
  ...
  methods: {
    ...
    // // 获取到的会话列表 存到vuex
    // GetAListOfSessions_vue(msg) {
    //   console.log('msg少时诵诗书所所所所所所所所所所',msg);
    //   // this.$store.commit("AListOfSessions", msg);
    // },
    // // 最新消息
    // latestNews(msg) {
    //   // if (!window.stype_News) {
    //     this.$store.commit("latestNews", msg);
    //   // }
    // },
    /**
     * @Author: 飞
     * @Date: 2021-06-11 13:47:53
     * @Describe:
     */
    // 初始化菜单按钮
    initMenuButton() {
