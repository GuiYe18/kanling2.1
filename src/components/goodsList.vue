      ...
      <div class="main" v-show="view == false">
        <dl v-for="(item, i) in goods" :key="i" @click.stop.prevent="gotoDetail(item.goods_id || item.id)">
          <dt v-if="item.thumb">
            ...
            <div class="good_Attributes s" :class="item.icon" v-show="item.brand_id == '5'">
              <!-- 推荐 -->
              ...
              <img src="../../assets/images/new_diy/Personal second-hand.png" v-if="item.icon == 3" alt="" /> -->
              <!-- <img src="../assets/images/new_diy/Personalsecond-hand.png" v-if="item.icon == 3" alt="" /> -->
              <img src="../assets/images/new_diy/entirelyNew@2x.png" v-if="item.icon == 1 || item.icon == 0" alt="" />
              <img src="../assets/images/new_diy/personageNew@2x.png" v-if="item.icon == 2" alt="" />
              <img src="../assets/images/new_diy/Personalsecond-hand.png" v-if="item.icon == 3" alt="" />
              <!-- <img src="../assets/images/new_diy/personageNew@2x.png" v-if="item.icon == 2" alt="" :class="item.icon"/> -->
            </div>
          </dt>
          <dt v-if="!item.thumb">
          ...
          <dd class="s3" style="line-height: 1.5625rem; height: 32px; margin: 0.25rem 0.375rem" :class="{ heightAuto: item.is_open_micro == 1 }" v-if="!showprice">
            <!-- <p class="s1"> -->
            <!-- <div class="s2">
...
export default {
  ...
  activated() {
    console.log("this.view", this.$router.history.current.fullPath.split("/brandgoods/")[1].split("?")[0]);
    this.exchange = this.$router.history.current.fullPath.split("/brandgoods/")[1].split("?")[0];
    this.page = 1;
    this.isLoadMore = this.last_page > 1;
