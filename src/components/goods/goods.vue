...
<template>
  <transition name="fade2">
    <div id="goods" v-show="showGood" :class="[fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
      ...
      <div ref="onePage" id="onePage s" style="overflow: hidden; min-height: 100vh">
        <div style="-webkit-overflow-scrolling: touch; min-height: 101vh" id="main">
          ...
          <van-row>
            <div class="info-box">
              <div class="title-box">
                ...
                <h2>
                  <van-col :span="24" id="price s" v-if="!isGoodsLove">
                    ...
                    <template v-if="!goodsInfo.goods_show || goodsInfo.goods_show.goods_detail_style != 1">
                      ...
                      <span id="price-num" v-else-if="goodsInfo.coupon">
          ...
          <div id="shopInfo" ref="goodinfo" class="section" :class="{ goodTop: goodTop == true, bottomMargin: isMarginBottom }" v-if="showPageB">
            <p style="" class="title-text s ss">商品详情</p>
            <div id="tabs">
      ...
      <div id="foot">
        ...
        <!--
        * @Author: 飞
        * @Date: 2021-04-20 11:08:23
        * @LastEditTime: 2021-05-10 13:11:19
        * @FilePath: \you-shop1\src\components\goods\goods.vue
        -->
        <template v-if="goodsInfo.brand_id == 7">
        ...
        * @Author: 飞
        * @Date: 2021-04-20 11:08:23
        * @LastEditTime: 2021-05-10 12:12:21
        * @FilePath: \you-shop1\src\components\goods\goods.vue
        -->
        <template v-if="goodsInfo.brand_id == 7">
          <div
        ...
        <div v-if="!isRent" class="buy cell">
          <div :class="{ nocar: !isGoods }" v-if="!is_o2o" @click="buyNow(goodsInfo.brand_id)">
            <!-- <block v-if="!isBuy"> 立即购买 </block> -->
            <block v-if="goodsInfo.brand_id == 5 || goodsInfo.brand_id == 7"> 立即购买 </block>
            <!-- v-show="goodsInfo.brand_id==5" -->
            <block v-if="goodsInfo.brand_id == 6"> 立即兑换 </block>
            <!-- <block v-if="condition==7"> 立即兑换 </block> -->
            <!-- <block > 立即兑s换 </block> -->
            <!-- <block > 立即兑s换 </block> -->
            <!-- aixintongdui -->
