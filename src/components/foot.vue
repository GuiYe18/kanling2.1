<template>
  <div id="foot" v-if="$store.state.temp.item.menustyle" :class="[fun.getPhoneEnv() == 3 ? 'pcStyle' : '', fun.isIphoneX() ? 'iphoneXStyle' : '']">
    <div
      id="allli"
      v-if="1"
      :class="{
    ...
    >
      ...
      >
        <div class="layers" v-if="item && item.subMenus && item.subMenus.length != 0" :class="{ laye: isShow == item.id }" :style="{ display: isShow == item.id ? 'block' : 'none' }">
          ...
          >
            <li v-for="(child, i) in item.subMenus" :key="i" :style="{ background: $store.state.temp.item.menustyle.bgcolor2 }">
              <a
            ...
            <div
              class="corner"
              :style="{
                'border-top-color': $store.state.temp.item.menustyle.bordercolor2
              }"
            ></div>
            <div
              class="corner2"
        ...
        <div
          ...
          :style="{
            borderColor: isele == ulrgl(item.url) ? $store.state.temp.item.menustyle.bordercolorhigh : $store.state.temp.item.menustyle.bordercolor,
            borderStyle: $store.state.temp.item.menustyle.showborder == 1 ? 'solid' : 'none',
            backgroundColor: isele == urlParse(item.url, isele) || page_id == urlParse(item.url, isele) ? $store.state.temp.item.menustyle.bgcolorhigh : $store.state.temp.item.menustyle.bgcolor
          }"
        >
          <!--<div class="bgcolors"-->
          ...
          <template v-if="item.icon">
            <i
              ...
              :class="item.icon"
              :style="{
                color: isele == urlParse(item.url, isele) || page_id == urlParse(item.url, isele) ? $store.state.temp.item.menustyle.iconcolorhigh : $store.state.temp.item.menustyle.iconcolor,
                padding: '0 0.5rem'
              }"
          ...
          <span
            ...
            :style="{
              color: isele == urlParse(item.url, isele) || page_id == urlParse(item.url, isele) ? $store.state.temp.item.menustyle.textcolorhigh : $store.state.temp.item.menustyle.textcolor,
