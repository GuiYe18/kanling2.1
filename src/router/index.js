...
// 数据分析
const DataAnalysis = r => require(['../views/dataAnalysis/DataAnalysis.vue'], r);
...
// 邀请推广
const ExtensionHome = r => require(['../views/member/extensionHome.vue'], r);
// 邀请列表
const Extensionitem = r => require(['../views/member/extension.vue'], r);
...
// 捐款
const Donate = r => require(['../views/kick/Donate.vue'], r);
// 捐款二维码
const DonationQRCode = r => require(['../views/kick/DonationQRCode.vue'], r);
// 捐款记录
const DonationRecord = r => require(['../views/kick/DonationRecord.vue'], r);

// 捐物协议
const DonationAgreement = r => require(['../views/kick/DonationAgreement.vue'], r);
// 捐赠协议
...
// 我的捐赠 订单   预约详情 
const BookingInfo = r => require(['../views/kick/BookingInfo.vue'], r);
// 我的捐赠 订单   支付费用 
...
// 二维码 收款界面
const Pay = r => require(['../views/pay/pay.vue'], r);

// Echarts
const Echarts = r => require(['../components/Echarts.vue'], r);
// // 我的首页 四扶总控
// const SifuMasterControl = r => require(['../views/Sifu/SifuMasterControl.vue'], r);
// 我的首页 四扶申请 
const Sifu = r => require(['../views/Sifu/Sifu.vue'], r);
// 我的首页 四扶审核中
const SifuUnderReview = r => require(['../views/Sifu/SifuUnderReview.vue'], r);
// 我的首页 四扶未通过
const SifuAuthenticationFailed = r => require(['../views/Sifu/SifuAuthenticationFailed.vue'], r);
// 我的首页 四扶详情
const FourSupportDetails = r => require(['../views/Sifu/FourSupportDetails.vue'], r);
// 我的首页 四扶提交成功
const ComMit = r => require(['../views/Sifu/comMit.vue'], r);
// 我的信息 单聊
const SolitudeChat = r => require(['../views/news/SolitudeChat.vue'], r);
// 我的信息 群聊
const GroupChat = r => require(['../views/news/GroupChat.vue'], r);

// 收支明细
const IncomeAndExpenditureDetails = r => require(['../views/IncomeAndExpenditureDetails/IncomeAndExpenditureDetails.vue'], r);
// 收支明细 订单详情
const OrderDetails = r => require(['../views/IncomeAndExpenditureDetails/OrderDetails.vue'], r);
// 收支明细 申请退款
const RequestARefund = r => require(['../views/IncomeAndExpenditureDetails/RequestARefund.vue'], r);
// 收支明细 退款详情
...
// 支付码审核中 商户入住 
const PaymentCodeUnderReview = r => require(['../views/MerchantSettled/PaymentCodeUnderReview.vue'], r);
// 支付码审核未通过 商户入住 
const PaymentCodeAuthenticationFailed = r => require(['../views/MerchantSettled/PaymentCodeAuthenticationFailed.vue'], r);
// 支付码审核通过 商户入住 
...
const routes = [
    ...
    // 支付码审核通过 商户入住 
    {
        path: '/ViewPaymentCode',
        component: ViewPaymentCode,
        name: 'ViewPaymentCode',
        meta: {
            title: '支付码审核通过',
            foot: true
        }
    ...
    // 支付码审核未通过 商户入住 
    {
        path: '/paymentCodeAuthenticationFailed',
        component: PaymentCodeAuthenticationFailed,
        name: 'PaymentCodeAuthenticationFailed',
        meta: {
            title: '支付码审核未通过',
            foot: true
        }
    ...
    // 支付码审核中 商户入住 
    {
        path: '/paymentCodeUnderReview',
        component: PaymentCodeUnderReview,
        name: 'PaymentCodeUnderReview',
        meta: {
            title: '支付码审核中',
            foot: true
        }
    ...
    // 收款码申请提交成功 商户入住 
    {
        path: '/cashCodeApplicationSubmissionSuccess',
        component: CashCodeApplicationSubmissionSuccess,
        name: 'CashCodeApplicationSubmissionSuccess',
        meta: {
            title: '提交成功',
            foot: true
        }
    ...
    // 收支明细
    {
        path: '/incomeAndExpenditureDetails',
        component: IncomeAndExpenditureDetails,
        name: 'IncomeAndExpenditureDetails',
        meta: {
            title: '收支明细',
            foot: true
        }
    ...
    // // 我的首页 四扶总控 
    // {
    //     path: '/sifuMasterControl',
    //     component: SifuMasterControl,
    //     name: 'SifuMasterControl',
    //     meta: {
    //         title: '四扶总控',
    //         foot: true
    //     }
    ...
    // 我的首页 四扶详情 
    {
        path: '/fourSupportDetails',
        component: FourSupportDetails,
        name: 'FourSupportDetails',
        meta: {
            title: '四扶详情',
            foot: true
        }
    ...
    // 我的首页 四扶未通过 
    {
        path: '/sifuAuthenticationFailed',
        component: SifuAuthenticationFailed,
        name: 'SifuAuthenticationFailed',
        meta: {
            title: '认证未通过',
            foot: true
        }
    ...
    // 我的首页 四扶审核中 
    {
        path: '/sifuUnderReview',
        component: SifuUnderReview,
        name: 'SifuUnderReview',
        meta: {
            title: '审核中',
            foot: true
        }
    ...
    // 捐物地址列表
    {
        path: '/releaseAddressList',
        component: releaseAddressList,
    ...
    // 发布捐物
    {
        path: '/releaseContribution',
        component: releaseContribution,
        name: 'releaseContribution',
        meta: {
            title: '发布捐物',
            foot: true
        }
    ...
    // 捐物协议
    {
        path: '/matterAgreement',
        component: MatterAgreement,
        name: 'MatterAgreement',
        meta: {
            title: '捐款捐物协议',
            foot: true
        }
