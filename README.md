...
<router-link :to="fun.getUrl('goods',{id:9})">测试</router-link>                         新版本
<router-link :to="{ name: 'goods', params: { id: item.goods_id },query:{i:toi,type:types}}">   老版本


this.$router.push(this.fun.getUrl('goods',{id:13}));           老版本
this.$router.push({name:'goods',params:{id:8},query:{i:2}});   新版本
...
/**
 * @Author: 飞
 * @Date: 2021-06-15 18:51:48
 * @Describe: 极光清除所有群聊
 */
      for (let index = 0; index < document.getElementsByClassName("jg-app-page-main")[0].children[0].children[0].children[0].children[0].children[1].children.length; index++) {
        document.getElementsByClassName("jg-app-page-main")[0].children[0].children[0].children[0].children[0].children[1].children[index].children[5].children[3].click();
        document.getElementsByClassName("modal-action-group")[0].children[1].click();
      }
